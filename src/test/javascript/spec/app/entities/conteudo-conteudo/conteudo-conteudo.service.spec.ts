...
describe('Service Tests', () => {
    ...
    describe('ConteudoConteudo Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ConteudoConteudoService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/conteudos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ConteudoConteudo', () => {
